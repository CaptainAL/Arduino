...
#define ZERO_VOLUME_RESISTANCE    2850.0    // Resistance value (in ohms) when no liquid is present.
#define CALIBRATION_RESISTANCE    2423.75    // Resistance value (in ohms) when liquid is at max line.
#define CALIBRATION_VOLUME        5.00    // Volume (in any units) when liquid is at max line.
